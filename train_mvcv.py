...
from sample4geo.dataset.mvcv import MVCVDatasetEval, MVCVDatasetTrainComplex2
...
class Configuration:
    ...
    # Model
    model: str = "BLIP-2-ViT-L--Remote-CLIP--Token-Pool--extra-sat_0.25_两个跨视角loss_1-random_grid"
...
if __name__ == "__main__":
    ...
    reference_dataset_test = MVCVDatasetEval(
        data_folder=config.data_folder,
        split="test",
        img_type="reference",
